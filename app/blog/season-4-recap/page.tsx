          ...
          >
            ...
            <div className="flex flex-col -mt-20 bg-white container-1080 rounded-2xl p-10 blog-main">
              ...
              <div className="blog-body text-[#000000] flex flex-col gap-y-6 mt-6">
                ...
                <p>
                  Welcome to the magical world of Hack This Fall 2024, where
                  some beautiful folks came, hacked, and had a good time. Hack
                  This Fall 2024 was held from 9th to 11th February 2024 at
                  Karnavati University, Gujarat. Now, let’s dive into what this
                  season of Hack This Fall was all about.
                </p>
                ...
                <ul className="list-disc list-inside">
                  ...
                  <li>
                    ...
                    energy and excitement as participants from various
                    backgrounds converged to exchange ideas and expertise.
                  </li>
                  <li>
                  ...
                  <li>
                    <span className="font-semibold">Mentorship:</span> Guiding
                    the participants through the hackathon were 20 selfless and
                    dedicated mentors, offering invaluable insights and support
                    to help teams navigate challenges and realize their visions.
                  </li>
                </ul>
                <p>
                ...
                <p>
                  ...
                  from Orkes and Vonage. The Opening Ceremony marked the
                  official start of the hackathon, and attendees dove into
                  hacking as the 36-hour countdown began. A dinner under the
                  open sky provided a refreshing break, followed by a GitHub
                  workshop and giveaways. Stroom, the nutrition partner, shared
                ...
                <p>
                  ...
                  mentoring focused on project implementation, preparing teams
                  for the challenges ahead. Lunch provided a much-needed break,
                  followed by mini-events from partners Orkes, Vonage, and MLH.
                  Participants enjoyed light snacks and high tea as the day drew
                  to a close while Orkes offered office hours at their booth.
                ...
                <p>
                  ...
                  completeness. Midnight snacks and a coloring mini-event
                  provided a brief respite from the intensity of hacking. Soft
                  submission approached, and at 8 am, hacking officially
                  concluded. Participants enjoyed a well-deserved breakfast
                  before the judging process began.
                </p>
                <p>
                ...
                <p>
                  ...
                  offered a diverse array of amenities and attractions to
                  enhance the overall experience for participants. The event
                  catered to various needs and interests, from comfortable
                  sleeping areas providing a retreat for rest between coding
                  sessions to engaging sponsor booths facilitating interactions
                ...
                <p>
                  ...
                  remarkable journey of innovation, collaboration, and
                  camaraderie that defined this extraordinary event. From the
                  vibrant exchanges during check-in to the jubilant celebrations
                  at the closing ceremony, every moment was a testament to the
                  power of community and creativity. With 132 projects created,
                  countless connections made, and memories to last a lifetime,
                  Hack This Fall 2024 will be remembered as a beacon of
                  innovation and a celebration of human ingenuity. As we look
                  forward to future editions of this incredible event, we invite
                  you to join us on a journey of innovation, collaboration, and
