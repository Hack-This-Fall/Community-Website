...
export const data = {
  ...
  title: "Hack This Fall 1.0 Recap 🛠️",
  image:
    "https://a.storyblok.com/f/182824/1921x1081/c580587950/season-1-recap-blog-png.png",
  date: "2020-11-02 18:30",
  author: {
            ...
            <div className="flex flex-col -mt-10 bg-white container-1080 rounded-2xl p-10 blog-main">
              ...
              <div className="blog-body text-[#000000] flex flex-col gap-y-6 mt-6">
                ...
                <p>
                  ...
                  society’s everyday problems, and ended up building 50+
                  projects, which was in line with our motto i.e. “Build &
                  Solve”. Hackers truly understood the value of our motto and
                  showed their excellent piece of innovation and problem-solving
                  skills. Not only this, we found hackers hacking individually
                  and collaborating in a team, but this didn’t stop them from
                  engaging with other hackers in a meaningful way.
                </p>
                <Image src="https://a.storyblok.com/f/181818/1500x844/31dc503747/nopath-copy-8-2x.png" />
                <p>
                  While we are talking about hackathons and especially about
                  Hack This Fall, it was not just limited to Coding and Building
                  stuff. Hackers also had a ton of fun learning new skills and
                  technologies. We hosted pre-hackathon speaker sessions where
                  industry professionals were invited. They shared their
                  knowledge about various domains like OpenSource, Game
                  Development, BlockChain, Hackathons, DevRel, Web Technologies,
                  Machine Learning, App Development, and whatnot; all these
                  sessions were indeed so insightful for all our hackers.
                </p>
                <p>
                  While the hackers were busy building their hacks, we also
                  arranged multiple mini-events for all, where anyone could
                  join, relax and enjoy their presence at the hackathon. Some of
                  the mini-events included “MS Paint Bob-Ross,” where we
                  flaunted our painting skills as we painted along with Bob Ross
                  himself. Additionally, we also had “Hacker Hangouts,” which
                  essentially helped everyone know more about each other. We
                  even played games like “Among Us” and “Space Team”, which was
                  a ton of fun. Not only this, but we also had “Mentor Connect”
                  sessions, where hackers could interact with mentors and get
                  feedback on their ideas/hacks.
                </p>
                <p>
                  All in all, Season 1 was a huge success, thanks to all the
                  fantastic hackers for joining and building with us. We
                  couldn’t have made the process of running a hackathon at such
                  a scale without the help & contribution of our elite panel of
                ...
                <p>
                  In the end, we bagged a lot of memories worth remembering.
                  With that being said, to level up the energy and enthusiasm
                  within the hacker community, we are excited to announce the
                  next edition. So join us this season to have a mind-blowing
